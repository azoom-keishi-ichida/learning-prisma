...
CREATE TABLE `users` (
    ...
    UNIQUE INDEX `users_organization_id_key`(`organization_id`),
...
CREATE TABLE `Organization` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NOT NULL,
    `status` ENUM('ARCHIVED', 'PUBLISDED') NOT NULL DEFAULT 'PUBLISDED',

    INDEX `Organization_name_status_idx`(`name`, `status`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
